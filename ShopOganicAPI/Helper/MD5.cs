...
namespace ShopOganicAPI.Helper
{
    public class MD5
    {
        ...
        private static string Encrypt(string toEncrypt, string securityKey, bool useHashing)
        {
            ...
            try
            {
                ...
                if (useHashing)
                {
                    ...
                    keyArray = hashmd5.ComputeHash(System.Text.Encoding.UTF8.GetBytes(securityKey));
                ...
                {
                    keyArray = System.Text.Encoding.UTF8.GetBytes(securityKey);
                }
        ...
        private static string Decrypt(string cipherString, string securityKey, bool useHashing)
        {
            ...
            try
            {
                ...
                retVal = System.Text.Encoding.UTF8.GetString(resultArray);
            }
            catch (Exception ex)
            {
                throw ex;
